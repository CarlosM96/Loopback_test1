...
#
# Generated by export_simulation on Fri Aug 27 14:05:23 -04 2021
#
################################################################################
...
'-reset_run' switch to the './gtwizard_1.sh' script.

./gtwizard_1.sh -reset_run
...
./gtwizard_1.sh -noclean_files

For more information on the script, please type './gtwizard_1.sh -help'.
