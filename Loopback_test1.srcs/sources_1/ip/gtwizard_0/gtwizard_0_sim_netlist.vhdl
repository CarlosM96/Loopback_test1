...
-- Command     : write_vhdl -force -mode funcsim -rename_top gtwizard_0 -prefix
--               gtwizard_0_ gtwizard_0_sim_netlist.vhdl
-- Design      : gtwizard_0
...
sync2_txpmaresetdone: entity work.gtwizard_0_gtwizard_0_sync_block_6
     port map (
...
sync_RXRESETDONE: entity work.gtwizard_0_gtwizard_0_sync_block_7
     port map (
      data_out => rxresetdone_s2,
      gt0_rxresetdone_out => gt0_rxresetdone_out,
      sysclk_in => sysclk_in
    );
sync_data_valid: entity work.gtwizard_0_gtwizard_0_sync_block_8
     port map (
      D(2) => \rx_state__0\(3),
...
sync_mmcm_lock_reclocked: entity work.gtwizard_0_gtwizard_0_sync_block_9
     port map (
...
sync_pll0lock: entity work.gtwizard_0_gtwizard_0_sync_block_10
     port map (
...
sync_run_phase_alignment_int: entity work.gtwizard_0_gtwizard_0_sync_block_11
     port map (
      GT0_RXUSRCLK_OUT => GT0_RXUSRCLK_OUT,
      data_in => run_phase_alignment_int_reg_n_0,
      data_out => run_phase_alignment_int_s2
    );
sync_rx_fsm_reset_done_int: entity work.gtwizard_0_gtwizard_0_sync_block_12
     port map (
      GT0_RXUSRCLK_OUT => GT0_RXUSRCLK_OUT,
      data_out => rx_fsm_reset_done_int_s2,
      gt0_rx_fsm_reset_done_out => \^gt0_rx_fsm_reset_done_out\
    );
sync_time_out_wait_bypass: entity work.gtwizard_0_gtwizard_0_sync_block_13
     port map (
      data_in => time_out_wait_bypass_reg_n_0,
      data_out => time_out_wait_bypass_s2,
      sysclk_in => sysclk_in
    );
sync_txpmaresetdone: entity work.gtwizard_0_gtwizard_0_sync_block_14
     port map (
      data_in => data_in,
...
sync_pll0lock: entity work.gtwizard_0_gtwizard_0_sync_block_2
     port map (
...
sync_time_out_wait_bypass: entity work.gtwizard_0_gtwizard_0_sync_block_4
     port map (
      data_in => time_out_wait_bypass_reg_n_0,
      data_out => time_out_wait_bypass_s2,
      sysclk_in => sysclk_in
    );
sync_tx_fsm_reset_done_int: entity work.gtwizard_0_gtwizard_0_sync_block_5
     port map (
      GT0_RXUSRCLK_OUT => GT0_RXUSRCLK_OUT,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity gtwizard_0_gtwizard_0_gtrxreset_seq is
  port (
...
end gtwizard_0_gtwizard_0_gtrxreset_seq;

architecture STRUCTURE of gtwizard_0_gtwizard_0_gtrxreset_seq is
...
sync0_RXPMARESETDONE: entity work.gtwizard_0_gtwizard_0_sync_block
     port map (
      data_in => data_in,
...
gtrxreset_seq_i: entity work.gtwizard_0_gtwizard_0_gtrxreset_seq
     port map (
      AR(0) => AR(0),
...
entity gtwizard_0_gtwizard_0_support is
  ...
  attribute EXAMPLE_SIM_GTRESET_SPEEDUP of gtwizard_0_gtwizard_0_support : entity is "FALSE";
