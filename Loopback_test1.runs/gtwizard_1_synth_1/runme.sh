...
HD_PWD='/home/daphnelme/Desktop/fullModeDAPHNE/Loopback_test1/Loopback_test1.runs/gtwizard_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gtwizard_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gtwizard_1.tcl
